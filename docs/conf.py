...
try:
    ...
    import micropython_shtc3
except ImportError:
    raise SystemExit("micropython_shtc3 has to be importable")
...
project = "MicroPython shtc3 Library"
creation_year = "2023"
...
htmlhelp_basename = "MicroPython_Shtc3_Librarydoc"
